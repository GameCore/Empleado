...
public class EmpleadoPorComision extends Empleado
{
    ...
    //constructor
    public EmpleadoPorComision( String nombre, String apellido, String numeroSeguroSocial, double ventasTotalesSemana, double porcentaje )
    {
    ...
    //establecer la tasa de comicion de empleado
